...
use ChrisVasey\Tinx\Models\Models;
use ChrisVasey\Tinx\Naming\Strategy;
use Exception;
...
{
    /**
     * @return \ChrisVasey\Tinx\Naming\Strategy
     * */
    ...
    /**
     * Accepts a string identifier (e.g. 'pascal') or any class implementing 'ChrisVasey\Tinx\Naming\Strategy'.
     *
    ...
    private static function resolveViaContainer($strategy, $models)
    {
        ...
        throw new Exception('Strategy must implement [ChrisVasey\Tinx\Naming\Strategy].');
    }
